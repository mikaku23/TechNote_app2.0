(function () {
    document.addEventListener("DOMContentLoaded", () => {
        ...
        if (!floating || !toggleBtn || !chatPopup || !closeBtn || !chatForm || !chatInput || !chatMessages || !sendBtn || !endpoint) {
            return;
        }
        ...
        function renderMessage(role, text) {
            ...
            node.className = role === "user" ? "msg user enter" : "msg bot enter";
        ...
        function renderAllMessages() {
            ...
            state.messages.forEach((item) => renderMessage(item.role, item.text));
        }
        ...
        async function openChat() {
            ...
            island.style.borderRadius = Math.max(btnRect.width, btnRect.height) + "px";
            ...
            requestAnimationFrame(() => {
                island.style.left = popupRect.left - (stretchW - popupRect.width) / 2 + "px";
                island.style.top = popupRect.top - (stretchH - popupRect.height) / 2 + "px";
            ...
            chatPopup.addEventListener("animationend", () => chatPopup.classList.remove("popup-settle"), { once: true });
        ...
        async function sendQuestion(question) {
            ...
            try {
                ...
                const reply = data?.reply || data?.message || "Tidak ada jawaban.";
                if (!res.ok) {
